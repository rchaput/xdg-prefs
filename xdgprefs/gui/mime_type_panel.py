...
class MimeTypePanel(QWidget):
    ...
    def __init__(self, mimedb):
        ...
        for mime_type in self.mimedb.types.values():
            item = MimeTypeItem(mime_type, self.list_widget)
            self.item_map[mime_type] = item
